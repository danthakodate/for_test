Shader "Jason/Build It/Water No Light"
{
    Properties
    {
        [Header(Standard)]
        ...
        // [Header(Foam)] // CHECK : Foam 설정시 본체에서 전부 하얗게 변하는 문제가 있어서 주석처리해둠
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _SurfaceScale, _SurfacePower, _SurfaceSpeed, _DepthPower, _DotPower, _DistortionPower, _DistortionSpeed, _NoiseScale;
