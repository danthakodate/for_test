/*
빌드잇에 사용된 SelectBox 와 같은 빈 오브젝트를 표현할 때 사용합니다.
거의 완전히 비어보이도록 옵션을 조절할 수 있고
반대로 형체만 존재하면서 빛나는 듯 한 오브젝트를 표현할 때도 사용할 수 있습니다.
*/
Shader "BuildItAssets/Stable/Empty"
{
    Properties
    {
        [Header(Default)]
