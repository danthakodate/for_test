//# signature=ZEPETO.Multiplay#e9b92f39845f494eb041920885f36a0b#0.0.4
// @ts-nocheck
declare module 'ZEPETO.Multiplay' {
    ...
    class RoomBase extends System.Object {
        ...
        public Connection: TransportBase;
        ...
        public ParseMessage($bytes: number[]):void;
    ...
    type ColyseusCloseEventHandler = (code: number) => void;
    var ColyseusCloseEventHandler: {new (func: (code: number) => void): ColyseusCloseEventHandler;}
